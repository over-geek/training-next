...
function Avatar({ name, className }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("inline-flex h-8 w-8 items-center justify-center rounded-full text-white text-sm font-medium", getAvatarColor(safeName), className),
...
"[project]/app/missing-trainings/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MissingTrainingsPage() {
    ...
    const fetchUncompletedTrainings = async ()=>{
        try {
            setIsLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$trainings$2f$training$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TrainingService"].getUncompletedTrainings();
            setTrainings(data);
            ...
            console.error('Failed to fetch uncompleted trainings:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to load missing trainings. Please try again.');
        } finally{
            setIsLoading(false);
        }
    };
    ...
    const filteredTrainings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return trainings.filter((training)=>training.name.toLowerCase().includes(searchTerm.toLowerCase()));
    }, [
        searchTerm,
        trainings
    ]);
...
//# sourceMappingURL=_d049f4e2._.js.map